              ...
              <div className="student__bio">
                <div>
                  ...
                  <p className="section-container__paragraph student__paragraph">
                    ...
                    Санкт-Петербурге. Отучился на инженера по системам
                    управления летательными аппаратами, но спустя 3 года работы
                    в космической отрасли понял, что хочу развиваться в другой
                    области. И вот я прошел курсы по web разработке и уже пол
                    года работаю в этой сфере
                  </p>
                </div>
                <a
